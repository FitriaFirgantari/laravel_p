          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img class="align-items-center" src="../../images/logo.jpg" alt="logo">
              </div>
              <h4>New here?</h4>
              <h6 class="font-weight-light">Silahkan isi pendaftaran dahulu</h6>
              <form method="POST" action="/user_register" class="pt-3">
                @csrf
                ...
                <div class="form-group">
                  <select class="form-control form-control-lg" name="sebagai" id="exampleFormControlSelect2">
